...
module.exports = {
    ...
    CAPTIONS: process.env.CAPTIONS === undefined ? 'Made By P∆IN BOT' : process.env.CAPTIONS,
    DISBGM: process.env.DISABLE_JID_BGM_FILTER === undefined ? false : process.env.DISABLE_JID_BGM_FILTER,
    STICKERP: process.env.AUTO_STICKER === undefined ? true : convertToBool(process.env.AUTO_STICKER),
    STICKER_PACKNAME: process.env.STICKER_PACKNAME === undefined ? '痛み,P∆IN🐦' : process.env.STICKER_PACKNAME,
    DISSTICKER: process.env.DISABLE_STICKER === undefined ? false : process.env.DISABLE_STICKER,
    BOT_NAME: process.env.BOT_NAME === undefined ? 'P∆IN BOT' : process.env.BOT_NAME,
    ...
    AMAZONE: process.env.AMAZONE === undefined ? 'P∆IN BOT' : process.env.AMAZONE,
    KTB: process.env.TAG_HEADER === undefined ? 'P∆IN BOT' : process.env.TAG_HEADER,
    FAKE_REMOVER: process.env.FAKE_REMOVER === undefined ? 'true' : process.env.FAKE_REMOVER,
    OWN: process.env.OWN === undefined ? '447418324374,0' : process.env.OWN,
    ...
    PANEL_COMMAND: process.env.PANEL_COMMAND === undefined ? 'pain' : process.env.PANEL_COMMAND,
